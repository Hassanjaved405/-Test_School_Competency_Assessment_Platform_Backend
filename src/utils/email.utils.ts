...
export const sendCertificateEmail = async (email: string, name: string, level: string, certificateNumber: string): Promise<boolean> => {
...
export const sendAssessmentFailureEmail = async (email: string, name: string, step: number, percentage: number): Promise<boolean> => {
